    ...
    <nav class="navbar navbar-expand-xl navbar-light w-100 p-0 bg-base-0 rounded shadow-sm">
        <div class="d-flex align-items-center d-xl-none px-3 py-3 font-weight-medium text-muted">            @php
                $menu = [
                    ...
                    'stats.revenue' => ['Revenue', 'attach-money'],
        ...
        <div class="collapse navbar-collapse border-top border-top-xl-0" id="stats-navbar">
            <ul class="navbar-nav flex-wrap justify-content-around w-100">
                ...
                <li class="nav-item {{ Route::currentRouteName() == 'stats.overview' ? 'active' : '' }}">
                    ...
                    <a class="nav-link d-flex align-items-center font-weight-medium py-3 px-3 {{ in_array(Route::currentRouteName(), ['stats.pages', 'stats.landing_pages', 'stats.exit_pages', 'stats.revenue']) ? 'active' : '' }}" href="#" id="behaviorDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <a class="dropdown-item {{ Route::currentRouteName() == 'stats.revenue' ? 'active' : '' }}" href="{{ route('stats.revenue', ['id' => $website->domain, 'from' => $range['from'], 'to' => $range['to']]) }}">{{ __('Revenue') }}</a>
                    </div>
                </li>
