...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('websites.new') }}" method="post" enctype="multipart/form-data" id="form-website">
            @csrf            <!-- Tab Navigation - Styled as Compact Button Navbar -->            <nav class="navbar navbar-expand-sm navbar-light bg-light dark-nav-tabs rounded mb-3 py-1 px-2">
            ...
            <!-- Tab Content -->
            <div class="tab-content" id="website-tab-content">                <!-- Tab 1: Domain, Notifications, and Privacy -->
