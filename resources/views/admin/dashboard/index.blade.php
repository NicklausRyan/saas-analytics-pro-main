                                ...
                                <div class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col text-truncate">
                                            <div class="text-truncate">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://icons.duckduckgo.com/ip3/{{ $website->domain }}.ico" class="rounded-circle width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}" rel="noreferrer">

                                                    <div class="text-truncate">
                                                        <a href="{{ route('admin.websites.edit', $website->id) }}" class="text-truncate">{{ $website->domain }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
